...
package com.seatrend.vendor.allinspection.zxing.decoding;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case R.id.auto_focus:
        Log.d(TAG, "Gotly auto-focus message");
      ...
      case R.id.restart_preview:
        Log.d(TAG, "Gotly restart preview message");
        restartPreviewAndDecode();
        break;
      case R.id.decode_succeeded:
        Log.d(TAG, "Gotly decode succeeded message");
        state = State.SUCCESS;
      ...
      case R.id.return_scan_result:
        Log.d(TAG, "Gotly return scan result message");
        activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
        activity.finish();
        break;
      case R.id.launch_product_query:
        Log.d(TAG, "Gotly product query message");
