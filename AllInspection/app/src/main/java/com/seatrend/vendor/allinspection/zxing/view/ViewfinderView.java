...
package com.seatrend.vendor.allinspection.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  private static final int    SCANNER_LINE_HEIGHT           =   4;
...
//  //扫描区域提示文本颜色
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    labelTextSize = array.getDimension(R.styleable.ViewfinderView_label_text_size, 12f);
  ...
  private void drawTextInfo(Canvas canvas, Rect frame) {
    ...
    canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT, paint);
  }
  ...
  private void drawLaserScanner(Canvas canvas, Rect frame) {
    ...
    if(scannerStart <= scannerEnd) {
      canvas.drawRect(frame.left+11, scannerStart, frame.right-11, scannerStart + SCANNER_LINE_HEIGHT, paint);
